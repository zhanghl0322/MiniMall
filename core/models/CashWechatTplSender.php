...
class CashWechatTplSender
{
     ...
     * 发送提现失败模板消息
     */
    public function cashFailMsgDemo()
    {
        \Yii::warning("拒绝体现通知Demo" ,'info');
        try {
            $data = [
    ...
    public function NonPaymentMsg()
    {
        ...
        try {
            $data = [
                ...
                'template_id' => 'ydx-ep98BVniTp63G8YjWDUzREGa11kEXvKKrFVUmbQ',
                'form_id' => 'c63bc568ea684ff8ae94f3785bb2184a',
