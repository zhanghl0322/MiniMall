...
class Goods extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['store_id', 'cat_id', 'status', 'addtime', 'is_delete', 'sort', 'individual_share', 'freight', 'use_attr', 'share_type', 'quick_purchase', 'hot_cakes', 'mch_id', 'goods_num', 'member_discount', 'virtual_sales', 'mch_sort', 'type', 'is_level', 'confine_count', 'is_negotiable','is_best','is_show'], 'integer'],
            ...
            [['video_url','supplier_url','supplier_name'], 'string', 'max' => 2048],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'is_negotiable' => '面议方式',
            'is_best' => '是否优选精品  0--否   1--是',//TODO 新增人工后台置顶商品优选  在购物车智能展示推荐该商品  2019-07-10 11点48分
            'is_show' => '是否显示  0--否   1--是',//TODO 新增人工后台商品显示控制  在小程序是否展示改商品  2019年8月7日16:36:18
            'supplier_url' => '供应商url',//TODO 新增供应商url  2019年8月26日10:14:58
            'supplier_name' => '供应商名称',//TODO 新增供应商名称 2019年8月26日10:15:07
        ];
    }
    ...
    //TODO 新增获取店铺名称 Allon
    public function getMchName($mch_id)
    {
        return Mch::findOne(['id' =>$mch_id ])->name;
    }
