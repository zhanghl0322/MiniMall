 ...
 * @property string $pay_desc //TODO 新增支付备注 2019年8月21日15:24:52
 * @property string $full_reduction_price //TODO 新增支付满减折扣 2019年9月25日09:07:20
 */
class Order extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['total_price','full_reduction_price', 'pay_price', 'express_price', 'first_price', 'second_price', 'third_price', 'coupon_sub_price', 'before_update_price', 'discount', 'express_price_1', 'rebate', 'before_update_express', 'share_price', 'currency'], 'number'],
            [['address_data', 'content', 'offline_qrcode', 'integral', 'words', 'seller_comments', 'pay_desc'], 'string'],
