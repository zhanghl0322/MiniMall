...
/**
 * This is the model class for table "{{%goods_qrcode}}".
 *
 * @property integer $id
 ...
 */
class GoodsQrcode extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['store_id', 'qrcode_bg', 'avatar_size', 'avatar_position', 'qrcode_size', 'qrcode_position', 'font_position', 'font', 'preview','goods_id'], 'required'],
            [['store_id', 'is_delete', 'addtime','goods_id'], 'integer'],
