...
class OrderBehavior extends BaseBehavior
{
    ...
    {
        //TODO 处理未在规定时间内付款的订单 发送待支付提醒  15分钟之内
...
//        ]);
        ...
        $this->SendMsgNoPayOrderTimeout($e); //处理未在规定时间内付款的订单、进行服务通知
    ...
    //TODO  服务通知  Allon  2019年7月15日15:26:10
    /**
     * @param $event
     * 检查没支付的超时订单、发送服务通知
     */
    private function SendMsgNoPayOrderTimeout($event)
    {
        \Yii::warning("==打印Form_Id信息==" ,'info');
//        $form_list = FormId::find()->where([
//            'AND',
//            [
//                'store_id' => 1,
//                'type' => 'form_id',
...
//
//            \Yii::warning("==打印Form_Id信息111==", 'info');
//        }
    }
