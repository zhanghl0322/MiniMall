...
class OrderSubmitForm extends OrderForm
{
    ...
    public $use_integral;
    public $formId;
    public $use_sub_price;//用户优惠券折扣
    public $use_discount;//用户满减折扣
    public $use_activity;//用户选中活动
    ...
    public function rules()
    {
        $rules = [
            ...
            [['formId'], 'trim'],
            [['use_discount','use_activity'], 'required']
        ];
    ...
    public function save()
    {
        ...
        foreach ($mchListData as &$mch) {
            ...
            //TODO 判断满减金额是否大于0  大于就扣除 2019年9月24日11:08:32
            if($this->use_discount>0)
            {
                $manjian_sub_price=($mch['total_price']/$max_price_union)*$this->use_discount;
                $man_jian_sub_price=round($manjian_sub_price, 0);
                $order->full_reduction_price=$man_jian_sub_price;//设置满减默认值
                $payPrice -=  $man_jian_sub_price;
                \Yii::warning($man_jian_sub_price.'===========ZHEKO============'.$payPrice,'info');
            }
