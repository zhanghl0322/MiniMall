    ...
    protected function getMchListData($submit = false)
    {
        ...
        foreach ($this->mch_list as $i => &$mch) {
            ...
            foreach ($mch['goods_list'] as $_goods) {
                ...
                array_push($result,array('goods_id'=>$_goods['goods_id'],'price'=>floatval($_goods['price']) ));//拼接{goods_id: 507, price: 60} 格式 数据
            }
            ...
            //处理多规格商品 过滤 2019年10月11日11:07:15
            $mch['goods_off_sub_list'] =$result; //TODO 结果输出一次组装
        }
