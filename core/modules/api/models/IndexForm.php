...
class IndexForm extends ApiModel
{
    ...
    public function search()
    {
       ...
       // \Yii::warning("==测试二级界面11111......==".$this->page_id ,'info');
        if($this->page_id) {
...
//            file_put_contents('test.json', $json_string);
            ...
            if($res['code'] == 0) {
                if($this->page_id == -1) {
                  //  \Yii::warning("==测试二级界面详情......==".$this->page_id ,'info');
      ...
      //  \Yii::warning("==测试二级界面......==".$this->page_id ,'info');
       // $this->getMiaoshaData();  //TODO 这一段重复执行  先屏蔽测试
