...
//        ]);
//
//        //TODO 处理满减活动存在时  提示选择满减活动的问题
//        $res['data']['discount_activities_list'] = $discount_activities;
//        $res['data']['discount_11']=1111;
    ...
    //TODO 以商品信息拉取满减活动优惠 2019年9月11日15:41:01
    private function getDiscountActivitiesList()
    {
        $discount_activities = DiscountActivities::findOne([
            'store_id' => $this->store_id,
            'is_delete' => 0,
