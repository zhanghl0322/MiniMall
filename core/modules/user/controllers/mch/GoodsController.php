...
{
    public $enableCsrfValidation = false; // TODO:csrf验证的问题，因为表单是自己写的，在Yii框架中，为了防止csrf攻击，对post的表单数据封装了CSRF令牌验证。  2019年9月5日14:02:05
    ...
    public function actionEdit($id = null)
    {
        ...
        if (\Yii::$app->request->isPost) {
            \Yii::warning( '=============isPostisPostisPostisPostisPost=============='.$_POST['supplier_name'],'info');
            $form->attributes = \Yii::$app->request->post();
            $form->supplier_name=  $_POST['supplier_name'];
            $form->supplier_url=  $_POST['supplier_url'];
            return $form->save();
        } else {
