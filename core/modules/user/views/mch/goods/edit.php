...
<!--                    商城商品拉取-->
            ...
            <div <?= in_array(get_plugin_type(), [2,5]) ? 'hidden' : '' ?> class="step-block" flex="dir:left box:first">
                ...
                <div>
                    <div class="form-group row">
                        <div class="col-3 text-right">
                            <label class=" col-form-label">是否精品推荐</label>
                        </div>
                        <div class="col-9 col-form-label">
                            <label class="radio-label">
                                <input <?= $goods['is_best'] == 0 ? 'checked' : null ?>
                                        value="0" name="model[is_best]" type="radio"
                                        class="custom-control-input">
                                <span class="label-icon"></span>
                                <span class="label-text">否</span>
                            </label>
                            <label class="radio-label">
                                <input <?= $goods['is_best'] == 1 ? 'checked' : null ?>
                                        value="1" name="model[is_best]" type="radio"
                                        class="custom-control-input">
                                <span class="label-icon"></span>
            ...
            <div <?= in_array(get_plugin_type(), [2,5]) ? 'hidden' : '' ?> class="step-block" flex="dir:left box:first">
                ...
                <div>
                    <div class="form-group row">
                        <div class="col-3 text-right">
                            <label class=" col-form-label">是否展示商品</label>
                        </div>
                        <div class="col-9 col-form-label">
                            <label class="radio-label">
                                <input <?= $goods['is_show'] == 0 ? 'checked' : null ?>
                                        value="0" name="model[is_show]" type="radio"
                                        class="custom-control-input">
                                <span class="label-icon"></span>
                                <span class="label-text">否</span>
                            </label>
                            <label class="radio-label">
                                <input <?= $goods['is_show'] == 1 ? 'checked' : null ?>
                                        value="1" name="model[is_show]" type="radio"
                                        class="custom-control-input">
                                <span class="label-icon"></span>
                                <span class="label-text">是</span>
                            </label>
            ...
            <div <?= in_array(get_plugin_type(), [2,5]) ? 'hidden' : '' ?> class="step-block" flex="dir:left box:first">
                ...
                <div>
                    <div class="form-group row">
                        <div class="col-3 text-right">
                            <label class=" col-form-label">供应商名称</label>
                        </div>
                        <div class="col-9">
                            <input class="form-control short-row" type="text" name="supplier_name"
...
<!--                                   :value="model.supplier_name">-->
                    ...
                    <div class="form-group row">
                        <div class="col-3 text-right">
                            <label class=" col-form-label">供应商Url</label>
                        </div>
                        <div class="col-9">
<!--                            <input class="form-control short-row" type="text" name="supplier_url"-->
<!--                                   value="--><?//= $goods['supplier_url'] ?><!--">-->
                            <input class="form-control short-row" type="text" name="supplier_url"
                                   v-model="model.supplier_url">
                        </div>
                    </div>
                </div>
            </div>
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (res.code == 0) {
                    ...
                    app.model.mch_sort = res.data.sort;// 商品排序
                    app.model.weight = res.data.weight;// 重量
