...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <form class="auto-form" method="post" style="display: inline-block;width: 50%;">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">账户密码</label>
                </div>
                <div class="col-sm-6">
                    <input class="form-control" name="model[summary]" value="<?= $model->summary ?>">
                    <div class="fs-sm" style="color: red">长度为8-14字符，支持数字大小写字母，不予许有空格，填写新密码后,单击“保存”即可</div>
                </div>
            </div>
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
