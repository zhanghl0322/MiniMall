...
//    public $is_show;
    ...
    public function rules()
    {
        return [
            ...
            ['attr', 'safe',],
            ['detail', 'string',],
            [['supplier_url','supplier_name'], 'string', 'max' => 255],
            ['detail', function () {
    ...
    {
        \Yii::warning( '=============searchsearchsearchsearchsearch=============='.$this->model->supplier_name,'info');
        //分类获取
        ...
        return [
            ...
            'data' => [
                ...
                'model' => [
                    ...
                    'supplier_name'=>$this->model->supplier_name,
                    'supplier_url'=>$this->model->supplier_url,
                ],
                'setting' => $setting
            ],
        ];
    ...
    {
        \Yii::warning('=============dsdsdsdsdsdsdsd=============='.$this->supplier_name,'info');
        ...
        if ($this->model->isNewRecord) {
            ...
            $this->model->is_show=1;
            $this->model->is_best=0;
        }
        $this->model->supplier_name=$this->supplier_name;
        $this->model->supplier_url=$this->supplier_url;
