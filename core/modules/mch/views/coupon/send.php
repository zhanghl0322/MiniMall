                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                        <div class="input-group mb-3" style="max-width: 250px">
                            <input class="form-control search-user-keyword" placeholder="ID"
                                   onkeydown="if(event.keyCode==13) {search_user();return false;}">
                            <input class="form-control search-user-keyword-name" placeholder="昵称"
                                   onkeydown="if(event.keyCode==13) {search_user();return false;}">
...
<script>
    ...
    function search_user() {
        ...
        var keyword_name = $(".search-user-keyword-name").val();
        btn.btnLoading("正在查找");
        $.ajax({
