...
/* @var \app\models\DiscountActivities $model */
...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <form class="form auto-form" method="post" autocomplete="off" return="<?= $urlManager->createUrl(['mch/discount/edit','id' => $model->id]) ?>">
            <div class="form-body">
                <div class="form-group row">
                    <div class="form-group-label col-3 text-right">
                        <label class=" col-form-label required">满减活动名称</label>
                    </div>
                    <div class="col-9">
...
<!--                隐藏hidden-->
                <div hidden class="form-group row">
                    <div class="form-group-label col-3 text-right">
                        <label class=" col-form-label required">活动范围</label>
                    </div>
                ...
                <div  class="form-group row" style="display: none">
                    <div class="form-group-label col-3 text-right">
                        <label class=" col-form-label required">满减活动有效期</label>
                    </div>
                    <div class="col-9 pt-1">
                        <label class="radio-label">
                            <input name="expire_type"
                                <?=$model->expire_type == null || $model->expire_type == 2 ? 'checked' : null ?>
                ...
                <div class="form-group row expire-type expire-type-2"
                     style="<?= $model->expire_type == 1 ? 'display:none' : null ?>">
                    <div class="form-group-label col-3 text-right">
                ...
                <div class="form-group row">
                    <div class="form-group-label col-3 text-right">
                        <label class=" col-form-label required">活动状态</label>
                    </div>
                    <div class="col-9 pt-1">
                        <label class="radio-label">
                ...
                <div class="form-group row">
                    <div class="form-group-label col-3 text-right">
                        <label class=" col-form-label required">满减规则一</label>
                    </div>
                    <div class="col-9">
                        <div class="input-group">
                            <span class="input-group-addon">满金额：</span>
                            <input class="form-control"
                                   id="min_price1"
                                   name="min_price1"
                                   value="<?= $model->min_price1 ? $model->min_price1 : 100 ?>">
                            <span class="input-group-addon">减金额：</span>
                            <input class="form-control"
                                   id="sub_price1"
                                   name="sub_price1"
                                   value="<?= $model->sub_price1 ? $model->sub_price1 : 50 ?>">
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    <div class="form-group-label col-3 text-right">
                        <label class=" col-form-label required">满减规则二</label>
                    </div>
                    <div class="col-9">
                        <div class="input-group">
                            <span class="input-group-addon">满金额：</span>
                            <input class="form-control"
                                   id="min_price2"
                                   name="min_price2"
                                   value="<?= $model->min_price2 ? $model->min_price2 : 200 ?>">
                            <span class="input-group-addon">减金额：</span>
                            <input class="form-control"
                                   id="sub_price2"
                                   name="sub_price2"
                                   value="<?= $model->sub_price2 ? $model->sub_price2 : 60 ?>">
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    <div class="form-group-label col-3 text-right">
                        <label class=" col-form-label required">满减规则三</label>
                    </div>
                    <div class="col-9">
                        <div class="input-group">
                            <span class="input-group-addon">满金额：</span>
                            <input class="form-control"
                                   id="min_price3"
                                   name="min_price3"
                                   value="<?= $model->min_price3 ? $model->min_price3 : 300 ?>">
                            <span class="input-group-addon">减金额：</span>
                            <input class="form-control"
                                   id="sub_price3"
                                   name="sub_price3"
                                   value="<?= $model->sub_price3 ? $model->sub_price3 : 70 ?>">
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    <div class="form-group-label col-3 text-right">
                        <label class=" col-form-label required">满减规则四</label>
                    </div>
                    <div class="col-9">
                        <div class="input-group">
                            <span class="input-group-addon">满金额：</span>
                            <input class="form-control"
                                   id="min_price4"
                                   name="min_price4"
                                   value="<?= $model->min_price4 ? $model->min_price4 : 400 ?>">
                            <span class="input-group-addon">减金额：</span>
                            <input class="form-control"
                                   id="sub_price4"
                                   name="sub_price4"
                                   value="<?= $model->sub_price4 ? $model->sub_price4 : 80 ?>">
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    <div class="form-group-label col-3 text-right">
                        <label class=" col-form-label required">满减规则五</label>
                    </div>
                    <div class="col-9">
                        <div class="input-group">
                            <span class="input-group-addon">满金额：</span>
                            <input class="form-control"
                                   id="min_price5"
                                   name="min_price5"
                                   value="<?= $model->min_price5 ? $model->min_price5 : 500 ?>">
                            <span class="input-group-addon">减金额：</span>
                            <input class="form-control"
                                   id="sub_price5"
                                   name="sub_price5"
                                   value="<?= $model->sub_price5 ? $model->sub_price5 : 100 ?>">
                        </div>
                    </div>
...
<!--                                    </div>-->
                ...
                <div class="form-group row">
                    <div class="form-group-label col-sm-2 text-right">
                        <label class="col-form-label">活动说明</label>
                    </div>
                    <div class="col-sm-5">
...
<script>
    ...
    //删除分类
    function delete_cat(cat_id,id){
        $.ajax({
            url: "<?=$urlManager->createUrl(['mch/discount/delete-cat'])?>",
            dataType: "json",
            data: {
                cat_id: cat_id,
                discount_id:id,
    ...
    //删除商品
    function delete_goods(goods_id,id){
        $.ajax({
            url: "<?=$urlManager->createUrl(['mch/discount/delete-goods'])?>",
            dataType: "json",
            data: {
                goods_id: goods_id,
                discount_id:id,
