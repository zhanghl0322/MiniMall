...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        ...
        <div class="card mb-4">
            <div class="card-header">满减商品CSV导入助手</div>
            <div class="card-block">
                ...
                <div flex="dir:left box:first">
                    <div>示例文件：</div>
                    <div>
                        <a href="<?= $baseUrl . '/chy-goods-mj.xlsx'?>">Excel示例文件</a>
                    </div>
                </div>
                <div class="text-danger">注意：导入的商品数量一次尽量控制在1000条以内、防止数据过多内存占用过高</div>
            </div>
        </div>
