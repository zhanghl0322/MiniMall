...
<!--                                        TODO 新增商品核对入口-->
                                        <div>
                                            <a class="btn btn-sm btn-primary mt-2"
                                               href="index.php?r=mch%2Fgoods%2Fgoods-edit&id=<?= $goods_item['id']?>">商品核对</a>

                                            <?php if ($goods_item['supplier_name']) : ?>
                                                <a class="btn btn-sm btn-primary mt-2"
                                                   href="<?= $goods_item['supplier_url']?>"><?= $goods_item['supplier_name']?></a>
                                            <?php endif; ?>
