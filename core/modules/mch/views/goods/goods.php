        ...
        <table class="table table-bordered bg-white table-hover">
            ...
            <?php foreach ($list as $index => $goods) : ?>
                <tr>
                    ...
                    <!--                    供应商-->
                    <td data-toggle="tooltip"
                        data-placement="top" title="<?= $goods->supplier_name ?>" class="text-left ellipsis" >
                        <a href="<?= $goods->supplier_url  ?>"  ><?= $goods->supplier_name ?></a>
                    </td>
                    <td class="ellipsis" data-toggle="tooltip"
                        data-placement="top"
                        title="<?= $goods->mch_id ?>"><span class="badge badge-info" style="width: 100%"> <?= $goods->getMchName($goods->mch_id) ?$goods->getMchName($goods->mch_id)  :  '平台自营' ?></span></td>
                    <td class="ellipsis" data-toggle="tooltip"
                        data-placement="top"
                    ...
                    <td class="nowrap">
                        <?php if ($goods->is_best== 1) : ?>
                            <label class="switch-label">
                                <input class="is_switch_best" type="checkbox" name="is_best" checked data-id="<?=$goods->id  ?>">
                                <span class="label-icon"></span>
                                <span class="label-text"></span>
                            </label>
                        <?php else : ?>
                            <label class="switch-label">
                                <input class="is_switch_best" type="checkbox" name="is_best" data-id="<?=$goods->id ?>">
                                <span class="label-icon"></span>
                                <span class="label-text"></span>
                            </label>
                        <?php endif; ?>
                    ...
                    <!-- TODO 新增是否商品展示div-->
                    <td class="nowrap">
                        <?php if ($goods->is_show== 1) : ?>
                            <label class="switch-label">
                                <input class="is_switch_show" type="checkbox" name="is_show" checked data-id="<?=$goods->id  ?>">
                                <span class="label-icon"></span>
                                <span class="label-text"></span>
                            </label>
                        <?php else : ?>
                            <label class="switch-label">
                                <input class="is_switch_show" type="checkbox" name="is_show" data-id="<?=$goods->id ?>">
                                <span class="label-icon"></span>
                                <span class="label-text"></span>
                            </label>
                        <?php endif; ?>
