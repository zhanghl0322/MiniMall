                            ...
                            <div <?= in_array(get_plugin_type(), [2,5]) ? 'hidden' : '' ?> class="step-block" flex="dir:left box:first">
                                ...
                                <div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <input class="form-control short-row" type="text" name="model[supplier_name]"
                                                   value="<?= str_replace("\"", "&quot", $goods['supplier_name']) ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-3 text-right">
                                        ...
                                        <div class="col-9">
                                            <input class="form-control short-row" type="text" name="model[supplier_url]"
