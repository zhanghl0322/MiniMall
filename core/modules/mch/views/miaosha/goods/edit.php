...
<!--                            <a flex="cross:center" class="head-step" href="#step5">分销设置</a>-->
                    ...
                    <div class="step-block" flex="dir:left box:first">
                        ...
                        <div>
                            ...
                            <!--TODO 新增商品商户附属归置 2019-07-02  14点35分 Allon-->
                            <div class="form-group row">
                                <div class="col-3 text-right">
                                    <label class=" col-form-label required">商户设置</label>
                                </div>
                                <div class="col-9">
                                    <select class="form-control short-row" name="model[mch_id]">
                                        <option value="0">车海洋平台自营</option>
                                        <?php foreach ($mchList as $mch) : ?>
                                            <option
                                                    value="<?= $mch->id ?>" <?= $mch->id == $goods['mch_id'] ? 'selected' : '' ?>><?= $mch->name ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
