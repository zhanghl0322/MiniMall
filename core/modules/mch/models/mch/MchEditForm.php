...
class MchEditForm extends MchModel
{
    ...
    public function rules()
    {
        $rules = [
            ...
            [['realname', 'tel', 'name', 'province_id', 'city_id', 'district_id', 'address', 'mch_common_cat_id', 'service_tel','summary'], 'string','max'=>250],//TODO 新增定义简介 临时密码
            [['user_id'], 'integer'],
    ...
    public function save()
    {
        ...
        $this->model->summary = $this->summary;//TODO 新增临时密码补充修改  2019-07-01 15点41分
