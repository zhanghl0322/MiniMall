...
class GoodsController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $arr = $form->getList();
        foreach ($arr[0] as $key => $goods) {
            //TODO 循环输出商户名称 Allon
            $mch_model = Mch::findOne(['id' => $arr[0][$key]['mch_id'],  'is_delete' => 0]);
            $arr[0][$key]['mch_id'] =$mch_model->name;
    ...
    {
        //TODO 补充设置秒杀商品时、补充商户信息 Allon  2019-07-02 14点44分
        \Yii::warning('==测试是否进入编辑界面==','info');
        ...
        //TODO 查询现有所有商户信息  过滤'is_open' => 1
        $mchList = Mch::find()->where(['store_id' => $this->store->id, 'is_delete' => 0, 'is_open' => 1])->all();
