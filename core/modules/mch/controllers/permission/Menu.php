            ...
            [
                ...
                'children' => [
                    ...
                    [
                        'name' => '评论CSV上传',
                        'is_menu' => true,
                        'route' => 'mch/goods/taobao-excel',
                    ],
                    [
                        'name' => '(P|V)记录',
                        'is_menu' => true,
                        'route' => 'mch/goods/goods-pv-list',
                    ],
                    [
                        'name' => '(U|V)记录',
                        'is_menu' => true,
                        'route' => 'mch/goods/goods-uv-list',
                    ],
                ],
            ],
            [
                'name' => '全部订单',//TODO 全部订单入口 处理更改记得更新缓存
                'is_menu' => true,
                'icon' => 'icon-activity',
...
//                    ],
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        'name' => '券发放记录',
                        'is_menu' => true,
                        'route' => 'mch/user/coupon-send-list',
                    ],
                ],
            ],
            [
            ...
            [
                ...
                'children' => [
                    ...
                    //TODO 新增满减活动设置管理界面 2019年9月10日09:43:51
                    [
                        'name' => '满减活动管理',
                        'is_menu' => true,
                        'route' => 'mch/discount/index',
                        'sub' => [
                            [
                                'name' => '满减活动编辑',
                                'is_menu' => false,
                                'route' => 'mch/discount/edit',
                            ],
                            [
                                'name' => '满减活动删除',
                                'route' => 'mch/discount/delete'
                            ]
                        ],
                    ],
                    [
                        'name' => '满减商品导入',
                        'is_menu' => true,
                        'route' => 'mch/discount/goods-excel',
                    ],
                ],
            ],
            [
