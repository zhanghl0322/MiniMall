...
//    余额提现
    ...
    //TODO 测试文件
    //TODO  form_id  通知成功  再次通知会出现  41029  41029 form_id id以使用  2019-7-13 10:21:56
    public function actionSendDemo()
    {
        $access_token = $this->wechat->getAccessToken();
        \Yii::warning("拒绝体现通知Demo".$access_token ,'info');
        try {
            $data = [
                'touser' => 'ohXJd5QFdDnjTasfN7k8jBuD-eHw',//ohXJd5QFdDnjTasfN7k8jBuD-eHw 于   ohXJd5RjpwBp8-QwLBnpg6CXB1-A Z
                'template_id' => 'ydx-ep98BVniTp63G8YjWDUzREGa11kEXvKKrFVUmbQ',
                'form_id' => 'wx13112723432173a50ec4d25f1225612900',
                'page' => 'pages/order/order?status=0',//点击进去跳转界面
                'data' => [
                    'keyword1' => [
                        'value' => '2019-7-13 11:08:47',
                        'color' => '#333333',
                    ],
                    'keyword2' => [
                        'value' => '12',
                    ...
                    'keyword4' => [
                        'value' => '温馨提醒：您有一份待付款的购物订单20190713105416597516',
                        'color' => '#333333',
                    ],
                ],
            ];
