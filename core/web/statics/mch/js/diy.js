...
$(document).on('click', '.modules', function () {
    //var active_list = $('.block.active')[0].innerText;//点击界面当前选中模板
   // console.table(active_list);
    var that = $(this);
    ...
    if (type == 'modal') {
     ...
     //   app.temp_list.push(JSON.parse(JSON.stringify(temp)));
        console.table(app.temp_list);//TODO 打印数组 tbale  https://www.cnblogs.com/yaogengzhu/p/10764405.html
        app.temp_list.splice( app.temp_index+1,0,JSON.parse(JSON.stringify(temp)));
    }
});
